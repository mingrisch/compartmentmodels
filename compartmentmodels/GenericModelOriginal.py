...
#        y=cy_conv_exp(list(self.time),list(self.curve),list(self.aif),tau)
    ...
    def fit_model(self, startdict,
        ...
        mp=mpfit(self.calc_residuals,startparameters,parinfo=parinfo,quiet=1)
    ...
    def get_AIC(self):
        ...
        if self.rc>0 :
            ...
            +2*(self.nooffreeparameters+1)*(self.nooffreeparameters+2)/(n-self.nooffreeparameters-2)
            return aic
        else:
            return False
